...
import 'package:shagher/packages/pages/home/components/drawer/lang/flag_lang.dart';
    ...
    return AlertDialog(
      ...
      content: SizedBox(
        ...
        child: Row(
          children: const [
            FlagLang(
                flag: PathImages.unitedArabEmiratesFlag, title: KeyLang.arabic),
            FlagLang(flag: PathImages.unitedStatesFlag, title: KeyLang.english)
          ],
        ),
      ),
      // * Button
